  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="showStudentRecords">Student Rocords </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="StudentallData">Student All Reocords</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="TeacherAdminPanel">Teacher Control Panel</a>
        </li>
